...
L["For nameplates & world units. |cffff3333Does not work with action bar binds.|r"] = true
L["Frames: %s"] = true
...
L["List"] = true
L["Mac:|r Cmd+LClick unavailable"] = true
...
L["Not Set"] = true
L["Note:|r Cmd + Left Click unavailable on Mac"] = true
L["Note:|r Command + Left Click cannot be bound on Mac."] = true
...
L["%d binds"] = true
L["[Linked]|r Profile matched to loadout"] = true
L["[Override]|r Loadout expects: %s"] = true
L["[Unassigned]|r Auto-create disabled"] = true
L["[Unassigned]|r No loadout detected"] = true
L["[Unassigned]|r Will auto-create on switch"] = true
L["— click to edit"] = true
...
L["This profile was created for |cffffffff%s|r.\nSome bindings may not be compatible with |cffffffff%s|r."] = true
L["Some bindings use spells that are not available\nto your current class or specialization."] = true
L["Profile: |cffffffff%s|r\n|cff33ee33%d compatible|r   |cffee3333%d incompatible|r   |cff888888%d total|r"] = true
...
L["Aura Designer supports healer specs\nand Augmentation Evoker.\n\nSelect a spec using the dropdown above\nto configure indicators in advance."] = true
L["Auto (%s)"] = true
...
L["Expire Alert"] = true
L["Expire Threshold %"] = true
L["Expire Threshold (s)"] = true
L["Expiring"] = true
